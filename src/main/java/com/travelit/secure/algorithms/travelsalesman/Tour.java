...
public class Tour{
    ...
    public Place getCity(int tourPosition) {
        return (Place)tour.get(tourPosition);
    }

    // Sets a city in a certain position within a tour
    public void setCity(int tourPosition, Place city) {
    ...
    public int getDistance(){
        if (distance == 0) {
            ...
            for (int cityIndex=0; cityIndex < tourSize(); cityIndex++) {
                ...
                Place fromCity = getCity(cityIndex);
    ...
    public boolean containsCity(Place city){
