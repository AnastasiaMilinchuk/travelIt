    ...
    $('#find-route').click(function() {
        ...
        getDurations(function(){
            ...
            ga.evolvePopulation(pop, function(update) {
                ...
                $('#route').html((update.population.getFittest().chromosome));
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="salesman" id="population-size">
                    ...
                    <tr hidden="hidden">
                        <td>Elitism: </td>
                        <td>
                            <select class="salesman" id="elitism">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="salesman" id="generations">
                                <option value="20">20</option>
                                <option value="50" selected="selected">50</option>
                                <option value="100">100</option>
                            </select>
                    ...
                    <tr hidden="hidden" class="ga-info" style="display:none;">
                    ...
                    <tr id="ga-buttons">
                        <td colspan="2"><button class="salesman" id="find-route">Start</button> <button class="salesman" id="clear-map">Clear</button></td>
                    </tr>
                </table>
            </div>
        </div>
